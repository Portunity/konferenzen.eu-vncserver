...
_server(0) {
	...
	try {
		if (certificate.size() > 0) {
			...
			//< achtung übergabe per referenz und offenbar wird ein poiinter auf die originale instanz verwendet
...
bool PresentationServer::run() {
	...
	// Wird die Pr�sentation irgendwann mit Gewalt beendet, dann kommen wir dem zuvor
	if (_useTimeOfDeath) {
